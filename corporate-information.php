...
<style>
.page-header {
    background: url(img/banners/Corporate-Information-Banner.png);
         ...
         <div class="container">
            <div class="row">
            	...
            	<div class="col-lg-12  col-sm-12 text-center wow fadeInUp pxsa" data-wow-delay="0.1s">
            		<h2 class="title mb-4 text-blue">Corporate Information </h2>
            	</div>

            	<div class="col-lg-4  col-sm-12 text-center wow fadeInUp pxsa" data-wow-delay="0.1s">
            		<div class="mb-4 text-justify mx-160">
            			<p class="text-blue"><strong>Board of Directors</strong></p>
						...
						<p class="text-black mb-0"><strong>Poo Lap Tuck</strong></p>
						<p><span style="white-space: nowrap;">Independent Non-Executive Director</span></p>
						 
						<p class="text-black mb-0"><strong>Dr. Gan Seng Kian</strong></p>
						<p><span style="white-space: nowrap;">Independent Non-Executive Director</span></p>
					...
					<!--
            		<div class="mb-4 text-justify mx-160">
            			<p class="text-blue"><strong>Listing</strong></p>
            			<p class="text-black">Ace Market</p>
            		</div>
            		<div class="mb-4 text-justify mx-160">
            			<p class="text-blue"><strong>Sector</strong></p>
            			<p class="text-black">Industrial Products & Services</p>
            		</div>
            		<div class="mb-4 text-justify mx-160">
            			<p class="text-blue"><strong>Website</strong></p>
            			<p class="text-black">www.zantat.com.my</p>
            		</div>

            		<div class="mb-4 text-justify mx-160">
            			<p class="text-blue"><strong>Registered Office</strong></p>
            			<p class="text-black">5-9A, The Boulevard Offices Mid Valley City Lingkaran Syed Putra 59200 Kuala Lumpur<br/><br/> <font class="text-blue bold">T</font> : +603-2282 6331</p>
            		</div> -->
            	</div>
            	...
            	<div class="col-lg-4  col-sm-12 text-center wow fadeInUp pxsa" data-wow-delay="0.1s">
            		...
            		<div class="mb-4 text-justify mx-160">
            			<p class="text-blue"><strong>Email&nbsp;Address&nbsp;And&nbsp;Website</strong></p>
            			<p class="text-black">Website: www.zantat.com.my</p>
            	...
            	<div class="col-lg-4  col-sm-12 text-center wow fadeInUp pxsa" data-wow-delay="0.1s">
					...
					<div class="mb-4 text-justify mx-160">
						...
						<p>Unit 32-01, Level 32, Tower A</p>
						<p>Vertical Business Suite</p>
						<p>Avenue 3, Bangsar South</p>
						<p>No. 8, Jalan Kerinchi</p>
						<p>59200 Kuala Lumpur</p>
						<p>Telephone: +603-2783 9299</p>
						<p>Email: is.enquiry@vistra.com</p>
            		</div>

					<div class="mb-4 text-justify mx-160">
            			<p class="text-blue"><strong>Stock Exchange Listing</strong></p>
						<p>ACE Market of the Bursa Malaysia</p>
						<p>Securities Berhad</p>
						<p>Stock Name: ZANTAT</p>
						<p>Stock Code: 0301</p>
            		</div>
